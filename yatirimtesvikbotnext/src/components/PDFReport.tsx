    ...
    <Document>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.headerPage1}>
          <Text style={styles.mainTitle}>Yatırım teşvik robotu</Text>
          <Text style={styles.subtitle}>Profesyonel yatırım teşvik analiz raporu</Text>
        </View>
        ...
        <View style={styles.reportInfo}>
          ...
          <View style={styles.reportInfoRow}>
            <Text style={styles.reportInfoText}>Analiz Türü: Yatırım Teşvik Uygunluk</Text>
            <Text style={styles.reportInfoText}>Durum: Tamamlandı ✓</Text>
          </View>
        </View>
        ...
        <View style={styles.infoCard}>
          <View style={styles.cardHeader}>
            <Text style={styles.cardTitle}>📍 Seçilen lokasyon ve faaliyet</Text>
          </View>
          ...
          <View style={styles.row}>
            <Text style={styles.label}>OSB/Endüstri:</Text>
            <Text style={styles.value}>{osb === 'evet' ? 'Evet' : 'Hayır'}</Text>
          </View>
          
          <View style={styles.descriptionBox}>
            <Text style={styles.descriptionText}>
              <Text style={{fontWeight: 'bold'}}>Faaliyet Tanımı: </Text>
              {naceValue?.tanim}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.infoCard}>
          <View style={styles.cardHeader}>
            <Text style={styles.cardTitle}>⭐ Yatırım özellikleri ve uygunluk</Text>
          </View>
          
          <View style={styles.statusContainer}>
            <View style={styles.statusRow}>
              <Text style={styles.statusLabel}>Hedef yatırım kapsamında mı?</Text>
              <Text style={isHedefYatirim ? styles.statusYes : styles.statusNo}>
                {isHedefYatirim ? 'Evet' : 'Hayır'}
              </Text>
            </View>
            
            <View style={styles.statusRow}>
              <Text style={styles.statusLabel}>Yüksek teknoloji listesinde mi?</Text>
              <Text style={isYuksekTeknoloji ? styles.statusYes : styles.statusNo}>
                {isYuksekTeknoloji ? 'Evet' : 'Hayır'}
              </Text>
            </View>
            
            <View style={styles.statusRow}>
              <Text style={styles.statusLabel}>Orta-yüksek teknoloji listesinde mi?</Text>
              <Text style={isOrtaYuksekTeknoloji ? styles.statusYes : styles.statusNo}>
                {isOrtaYuksekTeknoloji ? 'Evet' : 'Hayır'}
              </Text>
            </View>
            
            <View style={styles.statusRow}>
              <Text style={styles.statusLabel}>Öncelikli yatırım konusu mu?</Text>
              <Text style={isOncelikliYatirim ? styles.statusYes : styles.statusNo}>
                {isOncelikliYatirim ? 'Evet' : 'Hayır'}
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            Bu rapor Yatırım Teşvik Robotu tarafından otomatik olarak oluşturulmuştur.
          </Text>
        </View>
      </Page>

      {/* SAYFA 2 - DETAY BİLGİLER */}
      <Page size="A4" style={styles.page}>
        
        {/* Header Sayfa 2 */}
        <View style={styles.headerPage2}>
          <Text style={styles.mainTitle}>Destek bilgileri ve unsurları</Text>
          <Text style={styles.subtitle}>Detaylı analiz raporu - {selectedIl}</Text>
        </View>

        {/* Destek Bilgileri */}
        <View style={styles.supportCard}>
          <View style={styles.supportHeader}>
            <Text style={styles.cardTitle}>🎯 Destek bilgileri</Text>
          </View>
          
          <View style={styles.supportRow}>
            <Text style={styles.supportLabel}>Destek Bölgesi:</Text>
            <Text style={styles.supportValue}>{destekBolgesi || '-'}. Bölge</Text>
          </View>
        ...
        <View style={styles.supportElementsCard}>
          <View style={styles.supportElementsHeader}>
            <Text style={styles.cardTitle}>📋 Destek unsurları ({destekUnsurlari.length} adet)</Text>
          </View>
          ...
          {destekUnsurlari.length > 12 && (
            <View style={styles.descriptionBox}>
              <Text style={styles.descriptionText}>
                ...
                Tüm detaylar için web arayüzünü kullanınız.
              </Text>
            </View>
          )}
        </View>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            Detaylı bilgi ve güncel veriler için resmi kaynaklara başvurunuz.
          </Text>
        </View>
      </Page>
    </Document>
...
export const generateAndDownloadPDF = async (props: PDFReportProps) => {
  try {
    console.log('PDF oluşturma başlıyor...', props);
    
    const blob = await pdf(<PDFReport {...props} />).toBlob();
    console.log('PDF blob oluşturuldu:', blob);
    ...
    console.error('PDF oluşturma/indirme hatası:', error);
